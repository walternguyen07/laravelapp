 ...
 */
namespace App\Http\Requests\Backend\ProfessionalTitles;

use Illuminate\Foundation\Http\FormRequest;

class CreateProfessionalTitleRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-professionaltitle');
    }
