 ...
 */
namespace App\Http\Requests\Backend\RealEstateListings;

use Illuminate\Foundation\Http\FormRequest;

class UpdateRealEstateListingRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-realestatelisting');
    }
