...
?>
<!--Action Button-->
@if( Active::checkUriPattern( 'admin/khachhangs' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.khachhangs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.khachhangs.all' ) }}
            </a>
        </li>
        @permission( 'create-khachhang' )
            <li>
                <a href="{{ route( 'admin.khachhangs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.khachhangs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
