...
?>
<!--Action Button-->
@if( Active::checkUriPattern( 'admin/interests' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.interests.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.interests.all' ) }}
            </a>
        </li>
        @permission( 'create-interest' )
            <li>
                <a href="{{ route( 'admin.interests.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.interests.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
