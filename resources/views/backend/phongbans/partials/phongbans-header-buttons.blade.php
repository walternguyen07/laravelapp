...
?>
<!--Action Button-->
@if( Active::checkUriPattern( 'admin/phongbans' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.phongbans.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.phongbans.all' ) }}
            </a>
        </li>
        @permission( 'create-phongban' )
            <li>
                <a href="{{ route( 'admin.phongbans.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.phongbans.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
