...
?>
<!--Action Button-->
@if( Active::checkUriPattern( 'admin/watcheds' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.watcheds.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.watcheds.all' ) }}
            </a>
        </li>
        @permission( 'create-watched' )
            <li>
                <a href="{{ route( 'admin.watcheds.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.watcheds.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
